...
public class FreeCommentControl {
	...
	public void freeCommentWrite(@ModelAttribute FreeCommentVO commentVO, HttpSession session) {
	...
	public void freeCommentDelete(@RequestParam int free_num, int fcomment_num, HttpSession session) {

		commentService.commentDelete(fcomment_num);		
	}

	//모든 코멘트 삭제
	@RequestMapping(value="/freeAllCommentDelete.app")
	public void freeAllCommentDelete(@RequestParam int free_num, HttpSession session) {
		commentService.freeAllCommentDelete(free_num);
	}
