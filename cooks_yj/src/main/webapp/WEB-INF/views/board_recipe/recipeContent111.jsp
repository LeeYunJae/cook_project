...
$(document).ready( function() {
	...
	rcomment_num = ${last};
	alert("rcomment_num =>" + rcomment_num);
	...
	$("#comment_write").click( function() {
		$.ajax({
			...
			success : function(data) {
				commentVO = data.commentVO ;
				alert("성공 1");
				
				var html = '';
				
				html += '<div class="row">';
				html += '<div class="col-md-2 col-sm-3 text-center">' + commentVO.id + '</div>';
				html += '<div class="col-md-10 col-sm-9">';
				html += '<div class="panel" style="background: #F5F5F5">' + commentVO.rcomment_content;
				html += '<div class="row">';
				html += '<div class="col-xs-9">';
				html += '<small class="text-muted">' + commentVO.rcomment_date + '</small>';
				html += '</div>';
				html += '</div>';
				html += '</div>';
				html += '</div>';
...
/* 
function getComment(commentPageNum, event)  {
...
function clickLike(recipe_like) {
	$('#like').hide() ;
	$('#dislike').show() ;
				...
				<div class="col-sm-9 col-md-10 main">
					...
					<div class="panel panel-default">
						...
						<div class="panel-footer">
							<div id="inlineFooter">
								<a onclick="clickLike(${recipeVO.recipe_like})" id="like">좋아요</a>
					...
					<div class="well row" id="commentForm">
						...
						<!-- 기존에 있는 코멘트 읽어오기 -->
						<c:forEach var="comment" items="${recipeCommentList}">
							...
							<div class="row">
								...
								<div class="col-md-10 col-sm-9">
									<div class="panel" style="background: #F5F5F5">
										<c:out value="${comment.rcomment_content}"></c:out>
										<div class="row">
											<div class="col-xs-9">
												<small class="text-muted">
													<c:out value="${comment.rcomment_date}"></c:out>
												</small>
												<input type="hidden" id="rcomment_num" value="${comment.rcomment_num}">
											</div>
										</div>
									</div>
